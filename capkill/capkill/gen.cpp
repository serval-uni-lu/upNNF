...
int main(int argc, char** argv) {
    ...
    prj.add_compile_option("-Idependencies/networkit/include");
    prj.add_compile_option("-Idependencies/networkit/extlibs/tlx");
    ...
    prj.add_linker_option("./dependencies/networkit/build/libnetworkit.a");
