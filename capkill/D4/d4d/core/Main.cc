...
int main(int argc, char** argv)
{
  ...
  IntOption optMaximumDepth("MAIN", "max-depth",
               "Set the maximum depth during d-DNNF compilation (conjunction nodes don't count)\n", 10, IntRange(0,2147483647));
  ...
  OptionManager optList(optCache, optAnd, rPolarity, reducePrimalGraph, equivSimp, cacheStore, varHeuristic,
                        ...
                        strategyRedCache, freqLimitDyn, optMaximumDepth);
