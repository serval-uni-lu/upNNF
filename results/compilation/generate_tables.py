...
# total = pd.read_csv("csv/total.detail.csv", skipinitialspace = True)
...
ck8gb = pd.read_csv("csv/ck.scal.csv", skipinitialspace = True, index_col = 'file', dtype = {'ck_mc': str, 'd4d_mc': str})
...
ck8gb["ck_ok"] = (ck8gb.ck_status == "done") & (ck8gb.ck_d4_status == "done") & (ck8gb.ck_s_status == "done") & ((ck8gb.ck_time + ck8gb.ck_d4_time + ck8gb.ck_s_time) <= (5 * 3600))
...
def compilation_1_table(total, d4, dickc, ck, desc = ""):
    print(r"""\begin{table}[h!]
        \centering
        \begin{tabular}{l|c|c|c|c|c}
    ...
    print(r"""    \end{tabular}
            ...
            The last column indicates the number of formulae that were only compiled by \divkc, but not by \dfour or \capkc.""" + desc + r"""
        }
        \label{divkc:tab:gen}
    \end{table}
...
def compilation_2_table(total, d4, divkc, ck, desc = ""):
    print(r"""\begin{table}[h!]
        \centering
        \begin{tabular}{l|c|c|c|c|c}
    ...
    print(r"""    \end{tabular}
            \caption{Experimental results regarding the scalability of \divkc and \capkc.""" + desc + r"""
        }
        \label{divkc:tab:gen}
    \end{table}
...
def divkc_coverage(total, divkc, mc):
    print(r"""\begin{table}[h!]
        \centering
            \begin{tabular}{l|c|c|c|c|c}
...
def capkc_coverage(total, ck_amc, mc):
    print(r"""\begin{table}[h!]
        \centering
            \begin{tabular}{l|c|c|c|c|c}
...
def divkc_interval_precision(total, divkc, mc):
    print(r"""\begin{table}[h!]
        \centering
...
def capkc_interval_precision(total, ck_amc, mc):
    print(r"""\begin{table}[h!]
        \centering
...
def approxmc_accuracy(total, divkc, ck_amc, amc, mc):
    print(r"""\begin{table}[h!]
        \centering
            \begin{tabular}{l|c|c|c|c|c}
...
def approxmc_accuracy_2(total, divkc, ck_amc, amc, mc):
    print(r"""\begin{table}[h!]
        \centering
            \begin{tabular}{l|c|c|c|c|c}
                Dataset & \#F & $l \leq Y_{\textit{\approxmc}} \leq h$ & $l \leq Y_{\textit{\divkcamc}} \leq h$ & $l \leq Y_{\textit{\capkcamc}} \leq h$ \\ 
...
def approxmc_divkc_runtime(total, divkcn4, amc):
    print(r"""\begin{table}[h!]
        \centering
            \begin{tabular}{l|c|c|c|c|c|c}
...
def approxmc_capkc_runtime(total, ckn4, amc):
    print(r"""\begin{table}[h!]
        \centering
            \begin{tabular}{l|c|c|c|c|c|c}
...
def approxmc_capkc_runtime_2(total, ckn4, amc, mc):
    print(r"""\begin{table}[h!]
        \centering
            \begin{tabular}{l|c|c|c|c|c|c}
                Dataset & \#F & \#\capkcamc & $\textit{log}_{10}(\textit{min})$ & \textit{mean} & \textit{median} & $\textit{log}_{10}(\textit{max})$ \\
...
latex_header()
general_table(total)
compilation_1_table(total, d4, divkc, ck)
compilation_1_table(total, d4, divkc, ck8gb, r"In this experiment, \capkc was limited to 8GB and 360s for each \dfour trial.")
compilation_2_table(total, d4, divkc, ck)
compilation_2_table(total, d4, divkc, ck8gb, r"In this experiment, \capkc was limited to 8GB and 360s for each \dfour trial.")
divkc_coverage(total, divkc, mc)
capkc_coverage(total, ck_amc, mc)
divkc_interval_precision(total, divkc, mc)
capkc_interval_precision(total, ck_amc, mc)
approxmc_accuracy(total, divkc, ck_amc, amc, mc)
approxmc_accuracy_2(total, divkc, ck_amc, amc, mc)
approxmc_divkc_runtime(total, divkcn4, amc)
approxmc_capkc_runtime(total, ckn4, amc)
approxmc_capkc_runtime_2(total, ckn4, amc, mc)
latex_footer()
