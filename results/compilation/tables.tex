...
\begin{table}[h!]
	\centering
		\begin{tabular}{l|c|c|c|c}
            ...
            \hline 
Global & 323 & 0.985 & 0.00837 & 0.0257 \\
$\hookrightarrow$ Lagniez \cite{D4} & 168 & 0.982 & 0.00849 & 0.0257 \\
$\hookrightarrow$ Soos \cite{soos_2024_10449477} & 149 & 0.987 & 0.00837 & 0.0257 \\
$\hookrightarrow$ Plazar \cite{Plazar2019} & 4 & 1.000 & 0.00684 & 0.0257 \\
$\hookrightarrow$ Sundermann \cite{SBK+:SPLC24} & 2 & 1.000 & 0.0041 & 0.0041 \\
            \end{tabular}
            \caption{\capkc.
	}
	\label{divkc:tab:coverage}
