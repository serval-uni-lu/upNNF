...
\begin{table}[h!]
	\centering
		\begin{tabular}{l|c|c|c|c|c}
            ...
            \hline 
Global & 2713 & 0.973 & 0.871 & 298 & 0.826 \\
$\hookrightarrow$ Lagniez \cite{D4} & 1329 & 1.000 & 0.889 & 148 & 0.824 \\
$\hookrightarrow$ Soos \cite{soos_2024_10449477} & 1177 & 0.964 & 0.847 & 147 & 0.830 \\
$\hookrightarrow$ Plazar \cite{Plazar2019} & 185 & 0.838 & 0.892 & 3 & 0.667 \\
$\hookrightarrow$ Sundermann \cite{SBK+:SPLC24} & 22 & 1.000 & 0.955 & 0 & 0.000 \\
            \end{tabular}
            \caption{\capkc.
	}
	%\label{divkc:tab:coverage}
