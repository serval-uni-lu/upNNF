...
$\hookrightarrow$ Lagniez \cite{D4} & 230 & 0.996 & 0.978 & 0.974  \\
$\hookrightarrow$ Soos \cite{soos_2024_10449477} & 199 & 0.990 & 0.995 & 0.985  \\
$\hookrightarrow$ Plazar \cite{Plazar2019} & 45 & 1.000 & 1.000 & 1.000  \\
$\hookrightarrow$ Sundermann \cite{SBK+:SPLC24} & 43 & 1.000 & 0.977 & 0.977  \\
        \end{tabular}
    % \end{adjustbox}
